...
public  class  LogUtils  {
    ...
    private  static  String  mGlobalTag  =  "LogUtils";
    private  static  boolean  IS_SHOW_LOG  =  RetrofitConfig.DEBUG;
    ...
    private  static  String[]  wrapperContent(String  tagStr,  Object...  objects)  {
         ...
         * 支持全局TAG和局部TAG混搭
         *
         * 示例：KLog.i("使用全局的TAG");KLog.i("Test", "使用局部的TAG"); 执行结果：I/BoloLog: [ (Method.java:0)#Invoke ]
         * 使用全局的TAG I/Test: [ (Method.java:0)#Invoke ] 使用局部的TAG
         **/
        String tag = tagStr;
